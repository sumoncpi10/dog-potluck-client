                                                        ...
                                                        <div className="col-sm-6 col-xl-3">
                                                            ...
                                                            <div className="product-item">
                                                                ...
                                                                <div className="product-info">
                                                                    ...
                                                                    <button type="button" className="btn-product-cart" data-bs-toggle="modal"><a href="single-product.html">Buy Now</a>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-lg-8">
                                                                        <div className="product-info">
                                                                            ...
                                                                            <p className="desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatem quo, rerum rem soluta quisquam, repellat is deleniti omnis culpa ea quis provident dolore esse, offici modi dolorem nam cum eligendi enim!</p>
                                                                            <button type="button" className="btn-theme btn-sm" data-bs-toggle="modal" data-bs-target="#action-CartAddModal">
                                                                                Add To Cart
                                                                            </button>
                                                                        </div>
                                                                    </div>
